// @types/date-and-time is outdated, adding support for the .plugin method
// https://www.typescriptlang.org/docs/handbook/declaration-merging.html#module-augmentation

declare module "date-and-time" {
  export function plugin(name: string): void;

  // Types below are copied from /node_modules/@types/date-and-time/index.d.ts

  export type getDelta = () => number;

  export interface Subtract {
    readonly toMilliseconds: getDelta;
    readonly toSeconds: getDelta;
    readonly toMinutes: getDelta;
    readonly toHours: getDelta;
    readonly toDays: getDelta;
  }
